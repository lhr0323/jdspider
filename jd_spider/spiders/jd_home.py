...
class jd_spider(Spider):
    ...
    start_urls = []
    for i in range(1, 11):  
        url = 'https://list.jd.com/list.html?cat=1713,3287,3797&sort=sort_totalsales15_desc&trans=1&JL=6_0_0&page=' + str(i)
    ...
    def parse(self, response):  # 解析搜索页
        ...
        for good in goods:
           ...
           # item1['shop_name'] = good.xpath('./div/div[@class="p-shop"]/span/a/@title').extract()
